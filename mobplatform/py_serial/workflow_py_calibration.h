 ...
 * //+++++++++++++++++++++++++++++++++++++++++++++++++++
 * 28.11.2023
 * Нужно разделить время measureTime при калибровке и в обычном режиме.
 * Сейчас это везде 6000мс.
 * Сделаем при калибровке 3000мс.
 *
 *
 * //+++++++++++++++++++++++++++++++++++++++++++++++++++
 * 24.11.2023
 ...
 * Вспоминаем про DC low-pass filter.
 * Можно deltaT попробовать использовать в мс, а не в секундах как сейчас.
 *
 *
 * //+++++++++++++++++++++++++++++++++++++++++++++++++++
 * 23.11.2023
 * НАстроил на nvidia работу python3 (был только python2).
 * sudo update-alternatives --install /usr/bin/python python /usr/bin/python3.6 20
 * ...
 * update-alternatives: using /usr/bin/python3.6 to provide /usr/bin/python (python) in auto mode
 *
 * Запустил платформу "на полу". Стартует со скоростей 85-90 (на вису 24-32).
 * Едет ровно.
 * Дальше надо набрать статистику. Анализ файла csv.data
 *
 *
 *
 *
